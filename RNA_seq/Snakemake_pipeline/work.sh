# hisat2
snakemake -np -r --debug-dag hisat2_result/06.multiqc/multiqc_report.html --configfile config_hisat2.yaml --snakefile snakefile_hisat2_pe --cores 20
...
# star
snakemake -np -r --debug-dag star_result/05.multiqc/multiqc_report.html --configfile config_star.yaml --snakefile snakefile_star_pe --cores 20
